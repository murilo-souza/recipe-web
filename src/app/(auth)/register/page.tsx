  ...
  return (
    <div className="noise-overlay relative flex min-h-screen items-center justify-center overflow-hidden bg-zinc-900">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="animate-pulse-soft absolute -top-40 -right-40 h-125 w-125 rounded-full bg-purple-600/10 blur-3xl" />
        <div className="animate-pulse-soft absolute -bottom-40 -left-40 h-125 w-125 rounded-full bg-indigo-600/8 blur-3xl delay-700" />
        <div className="absolute top-1/3 left-1/2 h-75 w-75 -translate-x-1/2 rounded-full bg-violet-500/5 blur-3xl" />
      </div>

      <div className="animate-fade-in-up relative z-10 w-full max-w-105 px-5 py-10">
        {/* Logo */}
        <div className="mb-10 flex flex-col items-center">
          <div className="animate-float mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-purple-500 to-indigo-600 shadow-xl shadow-purple-500/25">
