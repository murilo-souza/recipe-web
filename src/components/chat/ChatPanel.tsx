...
export function ChatPanel({ recipeId, initialMessages }: ChatPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      {/* Header */}
      <div className="px-6 pt-6 pb-4 border-b border-zinc-700/40 shrink-0">
      ...
      {/* Input area */}
      <div className="px-5 py-4 border-t border-zinc-700/40 shrink-0">
        {error && (
        ...
        <div className="relative flex items-end gap-2 rounded-xl bg-zinc-800/60 border border-zinc-700/50 
          ...
          <button
            ...
            className="shrink-0 w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 
        ...
        <p className="text-zinc-600 text-[10px] mt-1.5 px-1">
          Pressione <kbd className="text-zinc-500 font-mono">Enter</kbd> para enviar, <kbd className="text-zinc-500 font-mono">Shift+Enter</kbd> para nova linha
        </p>
      </div>
    </div>
  );
